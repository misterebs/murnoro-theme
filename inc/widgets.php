<?php
function ebs_widgets_init() {
  // Register widgetized areas
  register_sidebar(array(
    'name'          => __('Primary Sidebar', 'ebs'),
    'id'            => 'sidebar-primary',
    'before_widget' => '<section id="%1$s" class="widget %2$s"><div class="widget-meta">',
...
add_action('widgets_init', 'ebs_widgets_init');
// Ebs Social Widget
class ebs_social_widget extends WP_Widget {
  ...
  function __construct() {
    ...
    parent::__construct('ebs_social_widget', __('Social by @misterebs_', 'ebs'), $widget_ops);
